...
> Given an array that contains $n$ elements, your task is to sort the elements in non-decreasing order.
...
sort (a[l..r]) :
	if l = r:
		Do nothing, subarray is already sorted
	m = ⌊(l + r) / 2⌋
	sort(a[l..m])
	sort(a[m + 1..r])
		Merge the sorted subarrays a[l..m] and a[m + 1..r] into a sorted subarray a[l..r]
```
